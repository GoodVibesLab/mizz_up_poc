...
public class MainActivity extends FlutterActivity {
    ...
    private CDCUSBDeviceManager usbDeviceManager = null;
                ...
                .setMethodCallHandler(
                        (call, result) -> {
                            if (call.method.equals("connect")) {
                                ...
                                try {
                                    String data = call.argument("data"); // Cast to String
                                    if (data != null) {
                                        usbDeviceManager.send(data);
                                        result.success("sent");
                                    } else {
                                        result.error("InvalidArgument", "Data is null", null);
                                    }
                                } catch (Exception e) {
                                    result.error("Exception", e.getMessage(), null);
                                }
                            }
                        }); // Corrected: Added closing bracket and semicolon here
    }
